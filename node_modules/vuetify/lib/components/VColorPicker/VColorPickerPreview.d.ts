...
export declare const makeVColorPickerPreviewProps: <Defaults extends {
    ...
    eyeDropperIcon: unknown extends Defaults["eyeDropperIcon"] ? {
        ...
        type: PropType<unknown extends Defaults["eyeDropperIcon"] ? IconValue : IconValue | Defaults["eyeDropperIcon"]>;
        default: unknown extends Defaults["eyeDropperIcon"] ? IconValue : NonNullable<IconValue> | Defaults["eyeDropperIcon"];
    };
};
