...
export declare const makeVColorInputProps: <Defaults extends {
    ...
    mode: unknown extends Defaults["mode"] ? {
        type: PropType<keyof typeof import("../../components/VColorPicker/util/index.js").modes>;
        default: string;
    ...
    modes: unknown extends Defaults["modes"] ? {
        type: PropType<readonly (keyof typeof import("../../components/VColorPicker/util/index.js").modes)[]>;
        default: () => string[];
        validator: (v: any) => boolean;
    } : Omit<{
        type: PropType<readonly (keyof typeof import("../../components/VColorPicker/util/index.js").modes)[]>;
    ...
    eyeDropperIcon: unknown extends Defaults["eyeDropperIcon"] ? {
        ...
        type: PropType<unknown extends Defaults["eyeDropperIcon"] ? import("../../composables/icons.js").IconValue : import("../../composables/icons.js").IconValue | Defaults["eyeDropperIcon"]>;
        default: unknown extends Defaults["eyeDropperIcon"] ? import("../../composables/icons.js").IconValue : NonNullable<import("../../composables/icons.js").IconValue> | Defaults["eyeDropperIcon"];
    };
    ...
    pipLocation: unknown extends Defaults["pipLocation"] ? {
        ...
        type: PropType<unknown extends Defaults["pipLocation"] ? "append" | "prepend" | "prepend-inner" | "append-inner" : "append" | "prepend" | "prepend-inner" | "append-inner" | Defaults["pipLocation"]>;
        default: unknown extends Defaults["pipLocation"] ? "append" | "prepend" | "prepend-inner" | "append-inner" : Defaults["pipLocation"] | NonNullable<"append" | "prepend" | "prepend-inner" | "append-inner">;
    };
    pipVariant: unknown extends Defaults["pipVariant"] ? {
        ...
        type: PropType<unknown extends Defaults["pipVariant"] ? "flat" | "text" | "elevated" | "tonal" | "outlined" | "plain" | undefined : "flat" | "text" | "elevated" | "tonal" | "outlined" | "plain" | Defaults["pipVariant"] | undefined>;
        default: unknown extends Defaults["pipVariant"] ? "flat" | "text" | "elevated" | "tonal" | "outlined" | "plain" | undefined : Defaults["pipVariant"] | NonNullable<"flat" | "text" | "elevated" | "tonal" | "outlined" | "plain" | undefined>;
    };
};
export declare const VColorInput: {
    ...
    swatches: PropType<import("vue").DeepReadonly<import("../../util/index.js").Color[][]>>;
    hideHeader: {
        type: PropType<boolean>;
        default: boolean;
    };
