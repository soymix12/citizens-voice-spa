...
function useTransition(source, options) {
  ...
  function executeTransition(out, from, to, options2) {
    const startTime = performance.now();
    const ease = PREFERS_REDUCED_MOTION() ? easingPatterns.instant : options2.transition ?? easingPatterns.easeInOutCubic;
...
// node_modules/vuetify/lib/util/timeUtils.js
...
function createRtl(i18n, options) {
  const rtl = ref(options?.rtl ?? genDefaults2());
...
//# sourceMappingURL=chunk-4MXWXHE7.js.map
